	...
	render() {
		return(
			<Table.Row>
				...
				onClick={() => this.props.handleRemoveButton(this.props.item._id)}>Remove</Button></Table.Cell>
				<Table.Cell><Button color="green"
				onClick={() => this.props.handleEditButton(this.props.item._id)}>Edit</Button></Table.Cell>
			</Table.Row>
		)
	}
}